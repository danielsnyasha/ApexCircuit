  ...
  return (
    <section id="process" className="relative py-24 sm:py-32 bg-background overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              >
                ...
                <div className="flex items-center justify-between mb-5">
                  ...
                  <div className="flex items-center gap-2">
                    <span className="text-[10px] dark:text-gray-500 text-gray-600 font-medium border dark:border-white/5 border-black/10 rounded-full px-2 py-0.5">
                      {step.duration}
                    </span>
                ...
                <p className="text-xs dark:text-gray-500 text-gray-600 leading-relaxed mb-5">{step.description}</p>
                ...
                <div className="space-y-1.5">
                  {step.deliverables.map((d) => (
                    <div key={d} className="flex items-center gap-2">
                      ...
                      <span className="text-[11px] dark:text-gray-500 text-gray-600">{d}</span>
                    </div>
                  ))}
                </div>
              </motion.div>
        ...
        >
          <p className="dark:text-gray-500 text-gray-600 text-sm mb-5">
